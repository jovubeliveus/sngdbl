c*****************************************************************
c
C> \mainpage sngdbl - Single-Double
C> 
C> sngdbl is a simple Fortran program to test single and double
C> precision building blocks for CG-like (Krylov Space) methods.
C> These are in particular matrix-matrix multiplication, matrix-vector
C> multiplication, dot product and ?axpy products. This was originally
C> written as a simple and portable benchmark with real life 
...
C>
C> \brief 
C>  Single and Double precision Fortran benchmark
C>
C> \details
C>  A benchmark of single and double precision fortran performance
C>  for algorithms used in CG-like applications.
C>
C> \author
C>  Joern Behrens
C>
C> \version 
C> 1.0 (original version)<br>
C> 2.0 (updated with doxygen documentation)
C> \date 2012
c*****************************************************************
C program sngdbl [len]
C> \brief This is the main program.
C> \param len: Length of array/matrix size (command line argument)
C> \result A number of MFlop/s rates on stdout 
	program sngdbl
c
C> parameters
...
c*****************************************************************
C subroutine smatgen
C> \brief Single precision matrix generation subroutine
C> \param aa    (real): Matrix of size (lda, n)
C> \param lda   (int) : Leading dimension of aa
C> \param n     (int) : Dimension of aa
C> \param norma (real): Maximum norm of aa
...
c*****************************************************************
C subroutine svecgen
C> \brief Single precision vector generation subroutine
C> \param aa    (real): Vector of size (n)
C> \param n     (int) : Dimension/Length of aa
C> \param norma (real): Maximum norm of aa
...
c*****************************************************************
C subroutine sinit
C> \brief Single Precision generation of all required matrices/vectors
C> \param aa    (real): Matrix of size (lda, n)
C> \param bb    (real): Matrix of size (lda, n)
C> \param ee    (real): Matrix of size (lda, n)
C> \param lda   (int) : Leading dimension of aa, bb, ee
C> \param nm    (int) : Second dimension of aa, bb, ee
C> \param cc    (real): Vector of size (n)
C> \param dd    (real): Vector of size (n)
C> \param nv    (int) : Length of cc, dd
...
c*****************************************************************
C subroutine dmatgen
C> \brief Double precision matrix generation subroutine
C> \param aa    (real): Matrix of size (lda, n)
C> \param lda   (int) : Leading dimension of aa
C> \param n     (int) : Dimension of aa
C> \param norma (real): Maximum norm of aa
